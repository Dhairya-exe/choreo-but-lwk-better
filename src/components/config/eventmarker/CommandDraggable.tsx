import { Add, Delete, DragHandle } from "../../icons/AppleIcons";
...
import { CommandVisualIcon } from "./CommandIconLibrary";
import { getCommandAppearance } from "./CommandAppearance";
...
class CommandDraggable extends Component<Props, State> {
  ...
  render() {
    ...
    const appearance = getCommandAppearance(command);
    return (
      <div
        style={{
      ...
      >
        ...
        >
          ...
          <Select
            ...
            onChange={(e) => {
              const type = e.target.value as CommandType;
          ...
          {command.isNamed && (
            <Select
              ...
              renderValue={(value) => value || "Select command"}
            >
              <MenuItem value="" disabled>
                {doc.globalCommandNames.length === 0
                  ? "Add commands in Settings"
                  : "Select command"}
              </MenuItem>
              {doc.globalCommandNames.map((name) => (
