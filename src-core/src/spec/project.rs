...
#[serde(rename_all = "camelCase")]
pub struct CommandVisualMetadata {
    #[serde(default)]
    pub icon: String,
    #[serde(default)]
    pub color: String,
    ...
    pub duration: f64,
    #[serde(default)]
    pub commands: Vec<CommandVisualMetadata>,
}

#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(rename_all = "camelCase")]
pub struct CommandAppearanceMetadata {
    #[serde(default)]
    pub icon: String,
    #[serde(default)]
    pub color: String,
...
#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(rename_all = "camelCase")]
pub struct PathVisualMetadata {
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub command_visuals: Vec<CommandVisualMetadata>,
    #[serde(default)]
    pub sweeps: Vec<PathSweepMetadata>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub active_sweep_id: Option<String>,
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub selected_sweep_ids: Vec<String>,
}

#[derive(Debug, Serialize, Deserialize, Clone, Default)]
pub struct ProjectUi {
    #[serde(default)]
    pub paths: BTreeMap<String, PathVisualMetadata>,
    #[serde(default)]
    pub commands: BTreeMap<String, CommandAppearanceMetadata>,
}
...
pub struct ProjectFile {
    ...
    /// Editor-only display metadata. This is deliberately ignored by trajectory
