...
const WaypointPanel = lazy(() => import("../config/WaypointConfigPanel"));
const ConstraintsConfigPanel = lazy(
  () => import("../config/ConstraintsConfigPanel")
);
const EventMarkerConfigPanel = lazy(
  () => import("../config/eventmarker/EventMarkerConfigPanel")
);
