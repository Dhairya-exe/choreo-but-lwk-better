...
const RobotConfigPanel = lazy(
  () => import("../components/config/robotconfig/RobotConfigPanel")
);
const KeyboardShortcutsPanel = lazy(
  () => import("../components/config/KeyboardShortcutsPanel")
);
const CodeGenConfigPanel = lazy(
  () => import("../components/config/CodeGenConfigPanel")
);
const CommandsConfigPanel = lazy(
  () => import("../components/config/commands/CommandsConfigPanel")
);

const deferredPanel = (panel: ReactElement) => (
  <Suspense fallback={<div className="lazy-panel-fallback">Loading…</div>}>
    {panel}
  </Suspense>
);
...
export const SETTINGS_TABS = [
  {
    name: "Robot Config",
    component: () => deferredPanel(<RobotConfigPanel />)
  },
  {
    name: "Controls",
    component: () => deferredPanel(<KeyboardShortcutsPanel />)
  },
  {
    name: "Commands",
    component: () => deferredPanel(<CommandsConfigPanel />)
  },
  {
    name: "Code Generation",
    component: () => deferredPanel(<CodeGenConfigPanel />)
  }
] as const;
